...
public class CRCCalculator {
	...
	private int crc;
	private int length;
	private MicroPNGQueue input;
	private MicroPNGQueue output;

	public CRCCalculator(MicroPNGQueue input, int length, int[] type) {
		crcTable = new int[256];
		crc = 0xffffffff;
		makeCrcTable();
		this.input = input;
		this.length = length;
		this.output = new MicroPNGQueue();
	...
	public MicroPNGQueue getOutputQueue() {
		return output;
	}
}
